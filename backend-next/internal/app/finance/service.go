...
// Service provides financial read-only views.
type Service struct {
...
func NewService(finance storage.FinanceStorage, companies storage.CompanyStorage, clock platform.Clock) *Service {
	return &Service{
		finance:   finance,
		companies: companies,
		clock:     clock,
