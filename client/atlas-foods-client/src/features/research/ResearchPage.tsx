...
function timeRemaining(completesAt: string | undefined, now: number = Date.now()): string {
      ...
      {isInProgress && (
        <div className="mt-auto space-y-1">
          ...
          <div className="flex items-center justify-between text-[9px] text-amber-500">
            ...
            <span>{timeRemaining(project.completesAt, now)}</span>
          </div>
          <button
