    ...
    <div className="flex items-center gap-1 bg-[#f5e6c8] border-b border-amber-700/30 px-1.5 py-1.5 shrink-0" style={{ minHeight: 52 }}>
      ...
      >
        ...
        <div className="leading-tight">
          <div className="text-[8px] text-amber-600/80 uppercase tracking-wider">Cash</div>
      ...
      <div className="flex items-center gap-1.5 bg-white/70 rounded-lg border border-amber-300/50 px-2 py-1 flex-1 min-w-[110px] shrink-0">
        ...
        <div className="flex-1 min-w-0 leading-tight">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold text-amber-900">Level {lvl}</span>
            <span className="text-[7px] text-amber-500 tabular-nums">{currentXp.toLocaleString()} / {xpToNext.toLocaleString()} XP</span>
          </div>
      ...
      >
        ...
        <div className="leading-tight">
          <div className="text-[8px] text-amber-600/80 uppercase tracking-wider">Power-up</div>
          <div className="text-[10px] font-semibold text-yellow-700">{powerupStatus}</div>
        </div>
      </button>
    </div>
  )
